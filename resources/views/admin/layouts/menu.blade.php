<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- User management -->
        <li class="menu-item {{ request()->is('admin/admin-users') || request()->is('admin/admin-users/*') || request()->is('admin/users') || request()->is('admin/users/*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('admin/admin-users') || request()->is('admin/admin-users/*') ? 'active open' : '' }}">
                    <a href="{{route('admin.admin-users.index')}}" class="menu-link">
                        <div data-i18n="Without menu">Admin Users</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('admin/users') || request()->is('admin/users/*') ? 'active open' : '' }}">
